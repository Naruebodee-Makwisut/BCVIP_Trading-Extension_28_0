report 70004 "AVTD_Req. Issue Inventory"
{
    // version AVTHLC1.0
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'TD-004/Rdlc/Request Issue Inventory.rdl';
        ...
        dataitem("Issue Header"; "AVTD_Issue Header")
        {
            ...
            dataitem("Item Journal Line"; "Item Journal Line")
            {
                ...
                begin
                    ...
                    //AVTMGVIP.002 30/10/2019 Add Code Check Decimal Quantity
                    Clear(QtyText);
                    if "Item Journal Line".Quantity mod 1 = 0 then
                        QtyText := Format("Item Journal Line".Quantity)
                    else
                        QtyText := Format("Item Journal Line".Quantity, 0, '<Precision,2:2><Sign><Integer Thousand><Decimals>');
            ...
            begin
                CLEAR(ReportName);
                ReportName := 'Request Adjust Inventory';
                ReportNameth := 'ใบขอปรับปรุงสินค้า';
