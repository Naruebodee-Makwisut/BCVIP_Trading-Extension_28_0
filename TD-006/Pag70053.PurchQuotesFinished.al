page 70053 "AVTD_Purch. Quotes - Finished"
{
    AdditionalSearchTerms = 'rfq,request for quote,purchase requisition';
    ApplicationArea = Suite;
    Caption = 'Purchase Quotes - Finished ';
    ...
    SourceTableView = WHERE("Document Type" = CONST(Quote), "AVTD_Finished PR" = filter(true));
    UsageCategory = Lists;
            ...
            group("&Quote")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        //For BC19
                        ApprovalMgt.RunWorkflowEntriesPage(Rec.RecordId, Database::"Purchase Header", Rec."Document Type", Rec."No.");
                    end;
                }
            }
        }
