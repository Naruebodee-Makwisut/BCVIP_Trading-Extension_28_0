page 70054 "AVTD_Sales Quotes - Finished"
{
    AdditionalSearchTerms = 'offer';
    ApplicationArea = Basic, Suite;
    Caption = 'Sales Quotes - Finished';
    ...
    SourceTableView = WHERE("Document Type" = CONST(Quote), "AVTD_Finished SQ" = filter(true));
    UsageCategory = Lists;
            ...
            group("&Quote")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        ApprovalMgt.RunWorkflowEntriesPage(Rec.RecordId, Database::"Sales Header", Rec."Document Type", Rec."No.");
                    end;
                }
                action(Dimensions)
                {
